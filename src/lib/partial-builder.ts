...
export const createPartialFromLibConfig = (libConfig: LibraryConfig): EslintConfigPartial => {
...
export const addConfigToPartial = (libConfig: LibraryConfig, partial: EslintConfigPartial|null = null): EslintConfigPartial => {
    if (partial === null) {
